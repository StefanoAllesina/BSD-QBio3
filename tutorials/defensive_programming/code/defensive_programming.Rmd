...
1. [Before writing code, draft your program as a series of modular functions with high-level documentation, and develop tests for it.](#pr1)
2. [Write clearly and cautiously.](#pr2)
3. [Develop one function at a time, and test it before writing another.](#pr3)
4. [Document often.](#pr4)
5. [Refactor often.](#pr5)
6. [When you run your code, save each "experiment" in a separate directory with a complete copy of the code repository and all parameters.](#pr6)
7. [Don't be *too* defensive.](#pr7)
...
### Principle 2. Write clearly and cautiously. {#pr2}

### Principle 3. Develop one function at a time, and test it before writing another. {#pr3}

### Principle 4. Document often. {#pr4}

### Principle 5. Refactor often. {#pr5}

### Principle 6. When you run your code, save each "experiment" in a separate directory with a complete copy of the code repository and all parameters. {#pr6}

### Principle 7. Don't be *too* defensive. {#pr7}
