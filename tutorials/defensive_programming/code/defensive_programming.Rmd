...
A general rule is that it is more important for scientific code to be readable than it is for it to be fast. Do not obsess too much about efficiency when writing.
...
Most of the time, the only numbers that should be hard-coded are 0 and 1.
